...
from simpsonitos.views import( index, PostList, PostDetail, 
PostUpdate, PostDelete, PostCreate, PostSearch, Login, SignUp, Logout, 
PostMineList, ProfileUpdate, ProfileCreate, MensajeCreate, MensajeDelete, MensajeList,about,  
)
...
urlpatterns = [
    ...
    path('mensaje/lista', MensajeList.as_view(), name="mensaje-list" ),
    path('mensaje/crear', MensajeCreate.as_view(), name="mensaje-create" ),
